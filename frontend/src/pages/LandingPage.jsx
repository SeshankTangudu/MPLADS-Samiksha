...
import { ShieldAlert, Users, Landmark, UserCog, Server, ArrowRight, CheckCircle2, Info, Lock } from 'lucide-react';
    ...
    <div className="min-h-[85vh] flex flex-col justify-center items-center py-10 space-y-10">
      ...
      <div className="text-center max-w-3xl space-y-4">
        ...
        <p className="text-sm text-slate-600 max-w-2xl mx-auto leading-relaxed">
          {t('landing.desc', 'Transparent oversight layer examining parliamentary constituency fund allocations across the 15th, 16th, 17th, and 18th Lok Sabha. Select a stakeholder role to enter the interactive workspace.')}
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 w-full max-w-7xl px-4">
        ...
        <div className="gov-card p-6 flex flex-col justify-between hover:shadow-xl transition-all border-t-4 border-t-blue-600 bg-white group">
          <div className="space-y-4">
            ...
            <p className="text-xs text-slate-600 leading-relaxed min-h-[3rem]">
              {t('roles.citizen_desc', 'Explore parliamentary allocations, review multi-signal indicators, and submit field reports.')}
            </p>
          ...
          <div className="pt-6">
            ...
            >
              <span>{t('roles.enter_citizen', 'Enter Public View')}</span>
        ...
        <div className="gov-card p-6 flex flex-col justify-between hover:shadow-xl transition-all border-t-4 border-t-amber-500 bg-white group">
          <div className="space-y-4">
            ...
            <div>
              ...
              <h2 className="text-lg font-bold text-slate-900">{t('roles.mp_title', 'Member of Parliament (MP)')}</h2>
            </div>
            <p className="text-xs text-slate-600 leading-relaxed min-h-[3rem]">
        ...
        <div className="gov-card p-6 flex flex-col justify-between hover:shadow-xl transition-all border-t-4 border-t-emerald-600 bg-white group">
          <div className="space-y-4">
            ...
            <div>
              ...
              <h2 className="text-lg font-bold text-slate-900">{t('roles.authority_title', 'District Authority / Officer')}</h2>
            </div>
            <p className="text-xs text-slate-600 leading-relaxed min-h-[3rem]">
        ...
        <div className="gov-card p-6 flex flex-col justify-between hover:shadow-xl transition-all border-t-4 border-t-purple-600 bg-white group">
          <div className="space-y-4">
          ...
          <div className="pt-6">
            <button
              ...
              className="w-full gov-btn-primary bg-purple-700 hover:bg-purple-800 text-white font-bold py-2.5 text-xs flex items-center justify-center gap-2 shadow-sm"
            >
              <span>{t('roles.enter_admin', 'Enter Operations Console')}</span>
              <ArrowRight className="w-4 h-4" />
            </button>
          </div>
        </div>
